...
public class KafkaConsumerService implements Runnable {
    ...
    static {
        ...
        consumerProperties.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, CFG.kafkaAddress());
        ...
        try {
            ...
            while (isRun.get()) {
                ...
                for (ConsumerRecord<String, String> record : records) {
                    String userJsonAsString = record.value();
                    try {
                        UserJson userJson = om.readValue(userJsonAsString, UserJson.class);
