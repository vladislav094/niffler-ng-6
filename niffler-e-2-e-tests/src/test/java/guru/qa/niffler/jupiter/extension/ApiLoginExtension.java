        ...
        AnnotationSupport.findAnnotation(context.getRequiredTestMethod(), ApiLogin.class)
                .ifPresent(apiLogin -> {
                    ...
                    if ("".equals(apiLogin.username()) || "".equals(apiLogin.password())) {
                        ...
                        List<UserJson> outcoming = usersApiClient.getAllOutcomingInvitations(apiLogin.username(), null);
                        List<UserJson> incoming = usersApiClient.getAllIncomingInvitations(apiLogin.username(), null);
